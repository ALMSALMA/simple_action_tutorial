...
(defsystem "my_robot_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "LineRobotAction" :depends-on ("_package_LineRobotAction"))
    (:file "_package_LineRobotAction" :depends-on ("_package"))
    (:file "LineRobotActionFeedback" :depends-on ("_package_LineRobotActionFeedback"))
    (:file "_package_LineRobotActionFeedback" :depends-on ("_package"))
    (:file "LineRobotActionGoal" :depends-on ("_package_LineRobotActionGoal"))
    (:file "_package_LineRobotActionGoal" :depends-on ("_package"))
    (:file "LineRobotActionResult" :depends-on ("_package_LineRobotActionResult"))
    (:file "_package_LineRobotActionResult" :depends-on ("_package"))
    (:file "LineRobotFeedback" :depends-on ("_package_LineRobotFeedback"))
    (:file "_package_LineRobotFeedback" :depends-on ("_package"))
    (:file "LineRobotGoal" :depends-on ("_package_LineRobotGoal"))
    (:file "_package_LineRobotGoal" :depends-on ("_package"))
    (:file "LineRobotResult" :depends-on ("_package_LineRobotResult"))
    (:file "_package_LineRobotResult" :depends-on ("_package"))
  ))