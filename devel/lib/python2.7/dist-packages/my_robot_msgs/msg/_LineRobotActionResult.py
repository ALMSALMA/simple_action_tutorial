...
"""autogenerated by genpy from my_robot_msgs/LineRobotActionResult.msg. Do not edit."""
import codecs
import sys
...
class LineRobotActionResult(genpy.Message):
  _md5sum = "88c4dd86448d5370be05c4d5e1ee0701"
  _type = "my_robot_msgs/LineRobotActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_robot_msgs/LineRobotResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LineRobotActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = my_robot_msgs.msg.LineRobotResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_robot_msgs.msg.LineRobotResult()
